...
public class TOWS extends JFrame {
	 ...
	 * Create the frame.
	 */
	public TOWS(ArrayList<Swot> sanse, ArrayList<Swot> pretnje, ArrayList<Swot> snage, ArrayList<Swot> slabosti,
			ArrayList<Strategija> strategije) {
		setTitle("TOWS");
	...
	public String vratiPrazan() {
		return textArea.getText();
	}

	public String vratiPrvi() {
		return textAreaS.getText();
	}

	public String vratiDrugi() {
		return textAreaW.getText();
	}

	public String vratiTreci() {
		return textAreaO.getText();
	}

	public String vratiCetvrti() {
		return textAreaSO.getText();
	}

	public String vratiPeti() {
		return textAreaWO.getText();
	}

	public String vratiSesti() {
		return textAreaT.getText();
	}

	public String vratiSedmi() {
		return textAreaST.getText();
	}

	public String vratiOsmi() {
		return textAreaWT.getText();
	}
}
